...
public class DatabaseManager {
    ...
    public CompletableFuture<List<SubredditLink>> getAllSubreddits() {
        return mapResultOf(getAllSubreddits, genericMap -> {
            ...
            return reddicord.getSubredditManager().getSubredditDataManager().getSubreddit(genericMap.get("subreddit")).join().map(subreddit -> new SubredditLink(channel, subreddit));
        });
    }
