...
import com.uddernetworks.corddit.discord.command.Command;
...
import static com.uddernetworks.corddit.discord.reaction.ReactManager.Codepoint.YELLOW_CIRCLE;
...
public class EvaluateCommand extends Command {
    ...
    public EvaluateCommand(Corddit corddit) {
        this.corddit = corddit;
        this.shell = new JShellRemote(corddit);
    }
