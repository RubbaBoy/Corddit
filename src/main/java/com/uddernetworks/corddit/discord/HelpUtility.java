...
public class HelpUtility {
    ...
    public static void send(Member member, TextChannel channel) {
        EmbedUtils.sendEmbed(channel, member, "Corddit Command Help", embed -> {
                    embed.setDescription("Help for the Corddit commands (**base** is just the base command, and no arguments)");
