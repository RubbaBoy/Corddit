package com.uddernetworks.corddit.database;
...
public class DatabaseManager {
    ...
    public DatabaseManager(Corddit corddit) {
    ...
    public void init(String databasePath) {
        ...
        var filePath = new File(databasePath + File.separator + "reddicord"); // TODO: Change the database name
    ...
    public CompletableFuture<List<SubredditLink>> getAllSubreddits() {
        return mapResultOf(getAllSubreddits, genericMap -> {
            ...
            return corddit.getSubredditManager().getSubredditDataManager().getSubreddit(genericMap.get("subreddit")).join().map(subreddit -> new SubredditLink(channel, subreddit));
        });
    }
