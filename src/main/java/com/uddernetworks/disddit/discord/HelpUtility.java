...
public class HelpUtility {
    ...
    public static void send(Member member, TextChannel channel) {
        EmbedUtils.sendEmbed(channel, member, "Disddit Command Help", embed -> {
                    embed.setDescription("Help for the Disddit commands (**base** is just the base command, and no arguments)");
